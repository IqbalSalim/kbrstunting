    ...
    public function store()
    {
        ...
        foreach ($data1 as $row) {
            Keluarga::create([
                ...
                'pus' => $row[10],
                'pus_hamil' => $row[11],
                'anak_tidak_sekolah' => $row[12],
                'tidak_memiliki_sumber_penghasilan' => $row[13],
                'lantai_tanah' => $row[14],
                'tidak_makan' => $row[15],
                'pra_sejahtera' => $row[16],
                'tidak_memiliki_sumber_air' => $row[17],
                'tidak_memiliki_jamban' => $row[18],
                'tidak_memiliki_rumah' => $row[19],
                'pendidikan_ibu_dibawah_sltp' => $row[20],
                'terlalu_muda' => $row[21],
                'terlalu_tua' => $row[22],
                'terlalu_dekat' => $row[23],
                'terlalu_banyak' => $row[24],
                'kbr_stunting' => $row[25],
                'rt' => $rt,
                'dusun_rw' => $dusunRw,
